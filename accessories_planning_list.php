...
<head>
    ...
    <title><?php echo SITE_TITLE;?> - Accessories Planning</title>
    <!-- Custom CSS -->
	<!--  datatables CSS -->
             ...
             <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">Accessories Planning List</h4>
							...
							<div class="card-body">
                                ...
                                <div class="row" style="float:right;">
                                        <div class="col-sm-12" style="float:right;" >
                                            <a href="accessories_planning.php">
                                                <button type="button" 
									...
									<table id="example" class="table table-striped table-bordered">
										...
										?>
											<tr id="delete_<?php echo $res_group['id'];?>">
												...
												<td><a href="acc_planning.php?id=<?php echo $res_group['id'];?>" title="Edit"><i class="fas fa-edit"></i></a> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <a href="accessories_costing_list.php?id=<?php echo $res_group['costing_no'];?>" title="Delete"> <i class="fas fa-window-close"></i></a> </td>
											</tr>
										<?php $g++;} ?>
										</tbody>
									</table>
