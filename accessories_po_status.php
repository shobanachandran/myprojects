...
if($_REQUEST['act']=='confirm_po'){
	$update_po = mysqli_query($zconn,"update store_po_master set status='Approved' where id='".$_REQUEST['id']."'");
	if($update_po){
		echo "<script>alert('PO Approved successfully!!');</script>";
	echo "<script>window.location.href='accessories_po_status.php';</script>";
	}
}
...
<body>
        ...
        <div class="page-wrapper">
             ...
             <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">ACCESSORIES PO APPROVAL</h4>
                    </div>
                </div>
            </div>
            ...
            <div class="container-fluid">
                        ...
                        <div class="card">
							<div class="card-body">
								...
								<table id="example" class="table table-striped table-bordered text-center">
									...
									<tbody>
				<?php
				$costing_sql = mysqli_query($zconn,"select * from store_po_master");
				$c=1;
				...
				?>
					...
					<td style="width: 24%">
					<?php if ($status=='SEND') { ?>
					<a href="accessories_po_edit.php?id=<?php echo addslashes($coldata['id']);?>"><i class="fas fa-edit"></i></a>  
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="view_accessories_po.php?id=<?php echo addslashes($coldata['id']);?>" ><i class="fas fa-eye"></i>
                </a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <a href="accessories_po_list.php?id=<?php echo $coldata['id'];?>&name=<?="delete"?>"><i class="fas fa-trash"></i></a> 
					<?php } else { ?>
					<a href="view_accessories_po.php?id=<?php echo addslashes($coldata['id']);?>" ><i class="fas fa-eye"></i></a>
					<?php } ?>
					</td>
					</tr>
					<?php
	...
	function approve(po_id){
		window.location.href="accessories_po_status.php?act=confirm_po&id="+po_id;
	}
