...
if(isset($_REQUEST['name'])=='delete'){
	$id=$_REQUEST['id'];
	$delete=mysqli_query($zconn,"delete from store_po_details where po_id='$id'");
	$delete=mysqli_query($zconn,"delete from store_po_master where id='$id'");
...
<head>
    ...
    <title><?php echo SITE_TITLE;?> - Accessories Po List </title>
    <!-- Custom CSS -->
	<!--  datatables CSS -->
             ...
             <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">Accessories Po List</h4>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
							<div class="card-body" >
								<div class="table-responsive" style="overflow:hidden;">
									...
									<a  href="accessories_po.php"><button type="button" 
						...
						<thead style="background-color: #626F80; color: #fff; padding: 0px; font-size: 12px;" >
									...
									<tbody>
	<?php
			$costing_sql = mysqli_query($zconn,"select * from store_po_master  order by id desc");
			$c=1;
			while($res_costing = mysqli_fetch_array($costing_sql,MYSQLI_ASSOC)){

			$style=$res_costing['style_no'];
 
			  $buyer_sql = mysqli_fetch_array(mysqli_query($zconn,"select * from store_po_details where po_id='".$res_costing['id']."'"));
			...
			<tr id="delete_<?php echo $c;?>">
				...
				<td><?php echo  $buyer_sql['styleno'];?></td>
				<td><?php echo $res_costing['grant_total'];?></td>
				<td><?php echo $res_costing['date'];?></td>
				<td><a href="accessories_po_edit.php?id=<?php echo addslashes($res_costing['id']);?>">
				<i class="fas fa-edit"></i></a>
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				<!-- <a href="javascript:;" onclick="$('#view_<?php echo $c;?>').slideToggle();">
				<i class="fas fa-eye"></i></a> -->
					 <a href="view_accessories_po_list.php?id=<?php echo addslashes($res_costing['id']);?>">
				<i class="fas fa-eye"></i></a>
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				<!-- <a href="javascript:;" onclick="costing_sheet(<?php echo $c; ?>);"><i class="fa fa-print"></i></a>  -->
				<a href="print_accessories_po_list.php?id=<?php echo $res_costing['id'];?>"><i class="fa fa-print"></i></a> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				<a href="accessories_po_list.php?id=<?php echo $res_costing['id'];?>&name=<?="delete"?>"><i class="fas fa-trash"></i></a>
			...
			<!-- <tr id="view_<?php echo $c;?>" style="background-color:#fff; display:none;">
				...
				<table id="example" class="table table-striped table-bordered display">
					...
					<?php
					$sql_details = mysqli_query($zconn,"select * from store_po_details where po_id='".$res_costing['id']."'");
					$t=1;
					$tot_wgt=0;
