...
<body>
                    ...
                    <div class="col-md-12">
                        <div class="card">
								...
								<div class="form-group row">
										...
										<div class="col-sm-6">
											<select class="select2 form-control custom-select" name="sel_buyer" id="sel_buyer" onchange="buyer_costing(this.value);" required>
									...
									<div class="form-group row">
										...
										<div class="col-sm-6">
										<?php 
								if($_REQUEST['id']!='' || $_REQUEST['sel_buyer']!='' ){ 		$cost_no1 = $cost_no;}?>
	...
	$sel_yname = mysqli_query($zconn,"select * from yarn_names where status='0'");
			...
			<td>
			<select class="select2 form-control custom-select" name="uom[]" id="uom<?php echo $rec; ?>">
			<option value="">Select</option>
			<?php 
					...
					<?php $rec++;}
							...
							<tr id="delete_0">
								...
								<?php
											...
											name="yname[]" id="yname0" onchange="this.form.submit()">
												<option>Select</option>	
												<?php  foreach($style_no1 as $style_no){ ?>
													<option value="<?php echo $style_no?>"
												 <?php if(in_array($style_no,$_REQUEST['yname'],true)){?>  
													selected="selected"<?php }?>><?php echo $style_no;?></option>
												<?php } ?>
											</select>
								...
								<td>
									<select class="select2 form-control custom-select"  id="yname0" name="yname[]">
										...
										$sel_yname = mysqli_query($zconn,"select * from yarn_names where status='0'");
										while($res_yname = mysqli_fetch_array($sel_yname,MYSQLI_ASSOC)){?>
											<option value="<?php echo $res_yname['yarn_name'];?>"><?php echo $res_yname['yarn_name'];?>
										</option>
										<?php } ?>
									 </select>
								   </td>
								...
								<td>
										<select class="select2 form-control custom-select" id="ytype0" name="ytype[]" onchange="sel_ytype(this.value,'0');">
										<option value="">Select</option>
										<?php $sel_ycounts = mysqli_query($zconn,"select * from yarn_types where status='0'");
										while($res_ycounts = mysqli_fetch_array($sel_ycounts,MYSQLI_ASSOC)){?>
											<option value="<?php echo $res_ycounts['yarn_type_name'];?>"><?php echo $res_ycounts['yarn_type_name'];?></option>
