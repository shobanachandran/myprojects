...
<head>
    ...
    <title><?php echo SITE_TITLE;?> - Yarn Type</title>
    <!-- Custom CSS -->
			...
			<input type="hidden" name="dept_id" id="dept_id" >
					<div class="col-md-4">
						<div class="form-group">
							<label for="cono1" class="control-label col-form-label">Yarn Type</label>
							<input type="text"  class="form-control" name="dt_name" id="dt_name"  placeholder="yarn type" required>
						</div>
					</div>
					<div class="col-md-4">
					<div class="form-group">
                    ...
                    <div class="col-md-12">
                        <div class="card">
							<div class="card-body">
								...
								<div id="dept_list"><?php echo yarntype_list();?></div>
								</div>
							</div>
                        </div>
                    </div>
    ...
    $('#example').DataTable();
	 ...
	 function save_dept(){
		  ...
		  $.ajax({
			...
			type: 'POST',
			data: formdata+'&action=saveYarnType',
