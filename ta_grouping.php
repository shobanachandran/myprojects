...
<body>
									...
									<table id="example" class="table table-striped table-bordered">
										...
										?>
											<tr id="delete_<?php echo $res_group['id'];?>">
												...
												<td><a href="ta_grouping_edit.php?id=<?php echo $res_group['id'];?>" title="Edit"><i class="fas fa-edit"></i></a>
                                                 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
                                                 <a href="javascript:;" title="Delete" onclick="Deleteaacg('<?php echo $res_group['id'];?>');">
	...
	function Deleteaacg(ID){
	  ...
	  if(UsrStatus){
		$.ajax({
			url : 'ajax/tagroup.php',
			data: {
			   action: 'accgroupdelete',
			   typeid: ID
			},
