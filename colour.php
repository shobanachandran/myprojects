...
<head>
    ...
    <title><?php echo SITE_TITLE;?> - Colour</title>
    <!-- Custom CSS -->
			...
			<input type="hidden" name="dept_id" id="dept_id" >
					<div class="col-md-4">
						<div class="form-group">
							<label for="cono1" class="control-label col-form-label">Colour Name</label>
							<input type="text"  class="form-control" name="dt_name" id="dt_name" placeholder="Colour Name" required>
						</div>
					</div>
					<div class="col-md-4">
					<div class="form-group">
					...
					<div class="form-group">
					<button type="submit" class="btn btn-success" onclick="save_colors();">Save</button>
                    ...
                    <div class="col-md-12">
                        <div class="card">
							<div class="card-body">
								...
								<div id="dept_list"><?php echo color_list();?></div>
								</div>
							</div>
                        </div>
                    </div>
	...
	function div_pop(){
	  ...
	  function save_colors(){
		  ...
		  $.ajax({
			...
			type: 'POST',
			data: formdata+'&action=saveColor',
