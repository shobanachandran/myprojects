...
<head>
    ...
    <title><?php echo SITE_TITLE;?> - Counts</title>
    <!-- Custom CSS -->
...
<body>
    <div id="main-wrapper">
        ...
        <div class="page-wrapper">
            ...
            <!-- ============================================================== -->
            <!-- ============================================================== -->
			<form id="user_department" onsubmit="save_dept();" method="post">
			...
			<input type="hidden" name="dept_id" id="dept_id" >
					<div class="col-md-4">
						<div class="form-group">
							<label for="cono1" class="control-label col-form-label">Counts</label>
							<input type="text"  class="form-control" name="dt_name" id="dt_name"  placeholder="Count Name" required>
						</div>
					</div>
					<div class="col-md-4">
					<div class="form-group">
							<label for="lname" class="control-label col-form-label">Description	</label>
							<textarea class="form-control" placeholder="description" name="dept_descr" id="dept_descr"></textarea>
						</div>
					</div>
					<div class="col-md-4">
					<div class="form-group">
                    ...
                    <div class="col-md-12">
                        <div class="card">
							<div class="card-body">
								...
								<div id="dept_list"><?php echo counts_list();?></div>
								</div>
							</div>
                        </div>
                    </div>
    ...
    $('#example').DataTable();
	 ...
	 function save_dept(){
		  ...
		  $.ajax({
			...
			type: 'POST',
			data: formdata+'&action=saveCountType',
			success: function( data ) {
				...
				if($.trim(data[0])=="1"){
					...
					$('#add_div').slideToggle();
					$('#infoMsg').fadeIn(5000);
					$('#infoMsg').html("successfully updated!!!");
				...
				if($.trim(data['0'])=="2"){
					...
					$('#add_div').slideToggle();
					$('#infoMsg').fadeIn(3000);
					$('#infoMsg').html("Record Exist in the Data(s)!!");
