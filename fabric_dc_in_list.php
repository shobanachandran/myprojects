...
<head>
    ...
    <title><?php echo SITE_TITLE;?> - FABRIC DC IN EDIT</title>
    <!-- Custom CSS -->
	<!--  datatables CSS -->
        ...
        <div class="page-wrapper">
             ...
             <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">FABRIC DC IN EDI</h4>
                    </div>
                </div>
            </div>
									...
									<table id="example" class="table table-striped table-bordered text-center">
										<thead>
											<tr>
                                                ...
                                                <th style="width: 10%">PARTY DC.NO</th>
										...
										<tbody>
											<?php
						$costing_sql = mysqli_query($zconn,"select * from fabric_dcin_master");
            $c=1;
            ...
            $style=$coldata['style_no'];
                   ...
                   <!--  <td ><?php  
					...
					<td style="width: 24%"><a href="edit_fabric_dc_in.php?id=<?php echo addslashes($coldata['dc_no']);?>&party_dc=<?php echo addslashes($coldata['party_dc']);?>&from=<?php echo addslashes($coldata['from_addr']);?>&order=<?php echo addslashes($coldata['order_no']);?>&style=<?php echo addslashes($coldata['style_no']);?>"><i class="fas fa-edit"></i></a>  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<!-- <a href="view_yarn_po.php?id=<?php echo addslashes($coldata['dc_no']);?>" ><i class="fas fa-eye"></i></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; --><a href="fabric_dc_in_list.php?id=<?php echo $coldata['dc_no'];?>&name=<?="delete"?>&party_dc=<?=$coldata['party_dc'];?>"><i class="fas fa-trash"></i></a> </td>
					</tr>
					<?php
					 $c++;	}
					?>
