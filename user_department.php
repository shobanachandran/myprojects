...
<head>
    ...
    <title><?php echo SITE_TITLE;?> - User Departments</title>
    <!-- Custom CSS -->
   <!--  datatables CSS -->  
             ...
             <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">User Department List</h4> &nbsp;&nbsp;&nbsp;&nbsp;
			...
			<input type="hidden" name="dept_id" id="dept_id" >
					<div class="col-md-4">
						<div class="form-group">
							<label for="cono1" class="control-label col-form-label">Department</label>
							<input type="text"  required class="form-control" name="dt_name" id="dt_name" placeholder="department" >
						</div>
					</div>
					<div class="col-md-4">
					<div class="form-group">
							<label for="lname" class="control-label col-form-label">Description	</label>
							<textarea  required class="form-control"  placeholder="description" name="dept_descr" id="dept_descr"></textarea>
						</div>
					</div>
					<div class="col-md-4">
					<div class="form-group">
                    ...
                    <div class="col-md-12">
                        <div class="card">
							<div class="card-body">
								...
								<div id="dept_list"><?php echo user_dept();?></div>
								</div>
							</div>
                        </div>
                    </div>
    ...
    $('#example').DataTable();
	  ...
	  function save_dept(){
		  ...
		  $.ajax({
			url : 'ajax/users.php',
			type: 'POST',
			data: formdata+'&action=saveUserDept',
	  ...
	  var UsrStatus = confirm("Are you sure to delete this Department details ?");
	  if(UsrStatus){
		  $('#user_department').trigger('reset');
		  $('#dept_id').val('');
		  $('#add_div').hide();
