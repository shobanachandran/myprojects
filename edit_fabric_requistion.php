                        ...
                        <div class="ml-auto text-right">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
									...
									<li class="breadcrumb-item active" aria-current="page"><a href="requistion.php">reuistion</a></li>
                                </ol>
                            </nav>
                        </div>
                    </div>
    ...
    <tbody>
        <thead style="background-color: #626F80; color: #fff; padding: 0px; font-size: 12px;">
            <tr>
                ...
                <th style="width:25%;">WGT</th>
                <th style="width:15%;">K.Loss</th>
...
<?php  $ronly='';if($costing_row>0){ $ronly='readonly';} else {$ronly='';}?>
                            ...
                            <div class="border-top">
                                <div class="card-body" style="margin-left: 250px;">
                                    ...
                                    <a href="fabric_requistion_list.php"><button type="button" class="btn btn-danger">List</button></a>
                                </div>
                            </div>
    </tbody>
</table>
...
function multiply(){
	...
	function multiplykl(){
		...
		if($(element).val()!="")
			sum1 += parseFloat($(element).val());
		});
		//alert(sum1);
		$('#tot_knit_loss').val(sum1);
	}
