...
<head>
    ...
    <title><?php echo SITE_TITLE;?> - Fabric Requistion List </title>
    <!-- Custom CSS -->
	<!--  datatables CSS -->
...
<body>
             ...
             <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">Fabric Rquistion</h4>
						<h4 class="page-title"></h4> &nbsp;&nbsp;&nbsp;&nbsp;
						<a href="requistion.php"> 
							<button type="button" class="btn btn-info">Fabric Requistion</button></a>
                        ...
                        <div class="ml-auto text-right">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
									...
									<li class="breadcrumb-item active" aria-current="page">Fabric requistion</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
	...
	<?php
			...
			<tr id="delete_<?php echo $c;?>">
				...
				<td><a href="edit_fabric_requistion.php?id=<?php echo addslashes($res_costing['id']);?>"><i class="fas fa-edit"></i></a> <!--&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="view_knitt_planning.php?id=<?php echo addslashes($res_costing['id']);?>"><i class="fas fa-eye"></i></a>-->&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
