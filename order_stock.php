...
<head>
    ...
    <title><?php echo SITE_TITLE;?> - ORDER STOCK</title>
    <!-- Custom CSS -->
	<!--  datatables CSS -->
			 ...
			 <form method="post" name="frm_stock">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">ORDER STOCK</h4>
							...
							<div class="card-body">
								...
								<?php if($_POST['stock_type']=='Yarn'){?>
									<table id="example" class="table table-striped table-bordered text-center">
										...
										<tbody>
										<?php $sel_yarn = mysqli_query($zconn,"SELECT * FROM `yarn_inward`");
										$sy=1;
										while($res_yarn = mysqli_fetch_array($sel_yarn,MYSQLI_ASSOC)){
											$sel_yarn_details = mysqli_fetch_array(mysqli_query($zconn,"SELECT * FROM `yarns_po_details` where po_id='".$res_yarn['po_no']."'"),MYSQLI_ASSOC);
										?>
										<tr>
											<td><?php echo $sy;?></td>
											<td><?php echo $res_yarn['style_no'];?></td>
											<td>yarn name</td>
											<td>count</td>
											<td>COLOUR</td>
											<td><?php echo $sel_yarn_details['weight']; ?></td>
											<td><?php echo $sel_yarn_details['rate']; ?></td>
											<td><?php echo $sel_yarn_details['grant_total']; ?></td>
										</tr>
