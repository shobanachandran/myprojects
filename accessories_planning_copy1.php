    ...
    function addRowBelowThead(tableId) {
        ...
        var row = '<tr>' +
           ...
           // '<td><input type="text" class="form-control" placeholder="Rate" name="rate[]"></td>' +
            '<td><input type="text" class="form-control total_qty" value="<?php echo $assdata['total_qty']; ?>" name="total_qty[]" ></td>' +
