...
<head>
    ...
    <title><?php echo SITE_TITLE;?> - Fabric add</title>
    <!-- Custom CSS -->
                        ...
                        <div class="ml-auto text-right">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page"><a href="fabric.php">Fabric Info</a></li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                        ...
                        <div class="card">
							<div class="card-body">
								...
								<div class="card-body" style="width:100%">
									<div class="form-group row">
										<label for="fname" class="col-sm-3 text-right control-label col-form-label">Fabric </label>
										<div class="col-sm-3">
											<select class="select2 form-control custom-select" style="">
							...
							<div class="border-top">
								<div class="card-body" style="margin-left: 250px;">
									...
									<a href="fabric.php"><button type="submit" class="btn btn-danger">Back</button></a>
								</div>
							</div>
                        </div>
                    </div>
