...
<body>
    <div id="main-wrapper">
        ...
        <div class="page-wrapper">
			...
			<form method="post" name="knitting_planning_list" id="knitting_planning_list">
             <div class="page-breadcrumb">
  			  ...
  			  <div class="ml-auto text-left">
						...
						<select 
                                            ...
                                            "select * from knitting_planning_master where 1 group by id");
											...
											<?php } else { ?>
											<option value="<?php echo $res_buyer['style_no'];?>">
	...
	<?php
		...
		if($_REQUEST['sel_buyer']!=''){
			$sql_buer = "where style_no='".$_REQUEST['sel_buyer']."'";
		} else {
			$sql_buer = "";
		}
		...
		// print_r($sql_buer);
			...
			"select * from knitting_planning_master ".$sql_buer."ORDER BY id DESC");
			$c=1;
			...
			?>
			<tr id="delete_<?php echo $res_costing['id'];?>">
				<td><?php echo $c;?></td>
				...
				<td><a href="edit_planning.php?id=<?php echo addslashes($res_costing['id']);?>">
				<i class="fas fa-edit"></i></a> 
				<!--&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="view_knitt_planning.php?id=<?php echo addslashes($res_costing['id']);?>"><i class="fas fa-eye"></i></a>-->&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				<a href="knitting_planning_list.php?id=<?php echo ($res_costing['id']);?>">
