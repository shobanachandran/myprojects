...
if(isset($_REQUEST['id'])){
	...
	$del_dept = mysqli_query($zconn,"delete from accessories_planning_list where costing_no='".$_REQUEST['id']."'");
    $del_dept = mysqli_query($zconn,"delete from accessories_planning where costing_no='".$_REQUEST['id']."'");
...
<head>
    ...
    <title><?php echo SITE_TITLE;?> - Accessories Requistion</title>
    <!-- Custom CSS -->
	<!--  datatables CSS -->
...
<body>
    <div id="main-wrapper">
        ...
        <div class="page-wrapper">
			...
			<form method="post" name="accessories_planning_list" id="accessories_planning_list">
            
             <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">Accessories Requistion List</h4>
  			  ...
  			  <div class="ml-auto text-left">
						<nav aria-label="breadcrumb">
							...
							<!-- <div class="btn-group"> -->
								  <!-- <a class="dropdown-item" style="background-color:#27A9E3; color:#fff; font-weight:bold;" 
                                  href="accessories_planning.php">New Accessories Planning </a> -->
                                  <label for="fname" style="font-size:16px;padding-left:10px;">Order No</label>
										...
										<div class="col-sm-3">
                                            ...
                                            "select * from 
                                            accessories_planning_list where 1 group by id");
                            ...
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page"><a href="">Merch</a></li>
									<li class="breadcrumb-item active" aria-current="page"><a href="reqistion.php">Accessories Requistion</a></li>
                                </ol>
                            </nav>
                        </div>
                    </div>
							...
							<div class="card-body">
                                ...
                                <div class="row" style="float:right;">
                                        <div class="col-sm-12" style="float:right;" >
                                            <a href="accessories_requistion.php">
                                                <button type="button" 
									...
									<table id="example" class="table table-striped table-bordered">
                                        ...
                                        "select * from accessories_planning_list ".$sql_buer." ORDER BY id DESC");
										$g=1;
										...
										?>
											<tr id="delete_<?php echo $res_group['id'];?>">
												...
												<td><a href="acc_requistion.php?id=<?php echo $res_group['id'];?>" title="Edit"><i class="fas fa-edit"></i></a> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <a href="accessories_requistion_list.php?id=<?php echo $res_group['costing_no'];?>" title="Delete"> <i class="fas fa-window-close"></i></a> </td>
											</tr>
										<?php $g++;} ?>
										</tbody>
									</table>
