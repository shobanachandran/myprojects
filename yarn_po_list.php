                ...
                <div class="row">
                    <div class="col-md-12">
						...
						<thead style="background-color: #626F80; color: #fff; padding: 0px; font-size: 12px;" >
									...
									<tbody>
	<?php
			$costing_sql = mysqli_query($zconn,"select * from yarns_po_master  order by id desc");
			$c=1;
			while($res_costing = mysqli_fetch_array($costing_sql,MYSQLI_ASSOC)){

			$style=$res_costing['style_no'];
 
			  $buyer_sql = mysqli_fetch_array(mysqli_query($zconn,"select * from yarns_po_details where po_id='".$res_costing['id']."'"));
			...
			<tr id="delete_<?php echo $c;?>">
				...
				<i class="fas fa-eye"></i></a> -->
					 <a href="view_yarn_po_list.php?id=<?php echo addslashes($res_costing['id']);?>">
				<i class="fas fa-eye"></i></a>
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				 <a href="javascript:;" onclick="costing_sheet(<?php echo addslashes($res_costing['id']);?>);"><i class="fa fa-print"></i></a>  
				<!--a href="yarn_po_print.php?id=<?php echo $res_costing['id'];?>"><i class="fa fa-print"></i></a--> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			...
			<!-- <tr id="view_<?php echo $c;?>" style="background-color:#fff; display:none;">
				...
				<table id="example" class="table table-striped table-bordered display">
					...
					<?php
					$sql_details = mysqli_query($zconn,"select * from yarns_po_details where po_id='".$res_costing['id']."'");
					$t=1;
					$tot_wgt=0;
