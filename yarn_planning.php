...
if($_POST['save_costing']=='saveCosting'){
	...
	$sel_insert = mysqli_query($zconn,"insert into yarn_entry_master(buyer_id,costing_no,order_no,style_no,
	fabric_name,total_value,yarn_date,created_by,created_date) values('".$_REQUEST['costing_no']."',
	'".$_REQUEST['costing_no']."','".$order_no."','".$style_no."','".$fabric_name."','".$grand_total."',
	'".$costing_date."','".$_SESSION['userid']."',now())");
	...
	if($sel_insert){
		...
		for($tr=0;$tr<$trows;$tr++){
			// $sel_buyer_det = explode("~~",$_POST['costing_no']);
			$ins_details = mysqli_query($zconn,"insert into yarn_entry_details(costing_no,yarn_id,yarn_name,yarn_count,
			yarn_type,yarn_colour,yarn_content,
			fabric_name,comp_id,consumption_value,consumption_percent,pcs_weight,uom_id,yarn_rate,yarn_total) 
			values('".$_REQUEST['costing_no']."','".$yarn_id."','".$_POST['yname'][$tr]."',
			'".addslashes($_POST['ycount'][$tr])."','".$_POST['ytype'][$tr]."','".$_POST['ycolor'][$tr]."',
			'".$_POST['content'][$tr]."','".$_POST['fabric_name'][$tr]."','".$_POST['ycomp'][$tr]."',
			'".$_POST['consumption_val'][$tr]."','".$_POST['consumption_per'][$tr]."','".$_POST['pcs_weight'][$tr]."',
			'".$_POST['uom'][$tr]."','".$_POST['yrate'][$tr]."','".$_POST['ytotal'][$tr]."')");
		}
	}
...
<head>
    ...
    <title><?php echo SITE_TITLE;?> - Yarn Planning</title>
    <!-- Custom CSS -->
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">Yarn Planning</h4>
                        ...
                        <div class="card">
								...
								<div class="card" style="width:50%; float:left; left: 50px; ">
									...
									<div class="form-group row">
									  ...
									  $sql = mysqli_query($zconn,"select * from order_entry_master where (`order_no`,`style_no`) 
									  NOT IN(select order_no,style_no from yarn_entry_master) and 
									  (`order_no`,`style_no`) IN (select order_no,style_no from process_planning_flow  where process_flow='demo')");
								...
								<option selected value="<?php echo $res_ycounts['yarn_type_name'];?>"><?php echo $res_ycounts['yarn_type_name'];?></option>
									...
									<td>
										...
										<script type="text/javascript">
												...
												<td>
													<input type="text" class="form-control" id="yrate<?php echo $co;?>" name="yrate[]" placeholder="Qty" autocomplete="off" onkeyup="cal_amount('<?php echo $co;?>');" value="<?php echo $order['cutting_qty'];?>">
												</td>
												<td>
					...
					<?php $co++; } ?>
							...
							<div class="border-top">
								<div class="card-body" style="margin-left: 250px;">
									...
									<a href="yarn_planning_list.php"><button type="button" class="btn btn-danger">List</button></a>
								</div>
							</div>
                        </div>
                    </div>
