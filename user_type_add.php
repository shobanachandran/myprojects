...
$action = 'usertypeadd';
	...
	if(isset($typeid)){
		...
		$action = 'usertypeedit';
		$breadcrumb = 'Edit';
		$edtUsrQry = "SELECT * FROM users_type WHERE TYPEID='".$typeid."'";
		$edtUsrResource = mysqli_query($zconn,$edtUsrQry);
		$usertypeData = mysqli_fetch_array($edtUsrResource,MYSQLI_ASSOC);
		$typeid = $usertypeData['TYPEID'];
		$typname = $usertypeData['TYPNAME'];
		$descrtion = $usertypeData['DESCRTION'];
...
<head>
    ...
    <title><?php echo SITE_TITLE;?> - User Type Add</title>
    <!-- Custom CSS -->
    <!-- Custom CSS -->
                        ...
                        <div class="ml-auto text-right">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page"><a href="user_type.html">User Type Info</a></li>
                                </ol>
                            </nav>
                        </div>
                    </div>
							...
							<div class="card-body">
								...
								<div class="card-body" style="width:100%">
									<div class="form-group row">
										<label for="fname" class="col-sm-3 text-right control-label col-form-label">User Type Name</label>
										<div class="col-sm-3">
                <input type="text" value="<?php echo $typname; ?>" class="form-control" tabindex="1" name="typname" id="typname" placeholder="Enter Usertype name">
										</div>
									</div>
									<div class="form-group row">
										<label for="lname" class="col-sm-3 text-right control-label col-form-label">Description	</label>
										<div class="col-sm-3">
               <textarea name="descrtion"  class="form-control" tabindex="2" id="descrtion"><?php echo $descrtion; ?></textarea>
										</div>
									</div>
									<div class="form-group row">
										<label class="col-sm-3 text-right control-label col-form-label">Status <span class="red">*</span></label>
					<div>
					<label>
