...
if(isset($_REQUEST['id'])){
	$del_dept = mysqli_query($zconn,"delete from other_costing_list where costing_no='".$_REQUEST['id']."'");
    $del_dept = mysqli_query($zconn,"delete from other_costing where costing_no='".$_REQUEST['id']."'");
...
<head>
    ...
    <title><?php echo SITE_TITLE;?> - Other Costing List Process</title>
    <!-- Custom CSS -->
	<!--  datatables CSS -->
             ...
             <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
						<h4 class="page-title">Other Process Costing List</h4>
                        &nbsp;&nbsp;&nbsp;&nbsp; <a href="costing.php"> <button type="button" class="btn btn-info">Costing Process</button></a>
                        <div class="ml-auto text-right">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
									<li class="breadcrumb-item"><a style="background-color:#626F80; color:#fff; color:#fff; margin:10px; padding:10px;" href="other_process_costing.php">Add New  </a></li>
									...
									<li class="breadcrumb-item active" aria-current="page">Other Process Costing</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                        ...
                        <li class="breadcrumb-item">
                            <label for="fname" style="font-size:16px;">&nbsp;Costing No</label>
                                <select data-placeholder="Begin typing a name to filter..." 
											...
											class="select2 form-control custom-select"  style="width: 200px;height: 40px; text-align:center;" 
                                name="sel_buyer" id="sel_buyer" onchange="$('#knitting_costing_list').submit();">
                                <option value="">Select</option>
                                <?php $sel_buyer = mysqli_query
                                ($zconn,"select * from costing_entry_master where 1 group by costing_no");
                                ...
                                <strong>(<?php echo $res_buyer['order_no'];?>)</strong></option>
                                <?php 
                                }
                                } ?>
                                </select>
							...
							<div class="card-body">
								<div class="table-responsive">
									<table id="example" class="table table-striped table-bordered">
                                        ...
                                        "select * from other_costing_list  ".$sql_buer." ORDER by id DESC");
										$g=1;
										...
										?>
											<tr id="delete_<?php echo $res_group['id'];?>">
												...
												<td><?php echo $sel_costing['costing_no'];?></td>
												 <!-- <td><?php echo $res_group['id'];?></td>  -->

												 <td><?php echo $res_group['order_no'];?></td> 
                                                 <td><?php echo $res_group['style_no'];?></td> 
                                  <!--                <td><?php echo $res_group['total'];?></td>  -->
												<td><a href="edit_other_process_costing.php?id=<?php echo $res_group['costing_no'];?>" title="Edit"><i class="fas fa-edit"></i></a> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
													<!--a href="other_costing_list.php?id=<?php echo $res_group['costing_no'];?>" title="Delete"> <i class="fas fa-window-close"></i></a-->
												</td>
											</tr>
										<?php $g++;} ?>
										</tbody>
