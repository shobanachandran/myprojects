...
<head>
    ...
    <title><?php echo SITE_TITLE;?> - Nik ID</title>
    <!-- Custom CSS -->
...
<body>
    <div id="main-wrapper">
        ...
        <div class="page-wrapper">
             ...
             <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">Nik Id</h4>&nbsp;&nbsp;&nbsp;&nbsp;
						<a href="admin_master.php"> <button type="button" class="btn btn-info">Admin Master</button></a>
                        <div class="ml-auto text-right">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
									<li class="breadcrumb-item"><a href="javascript:;" onclick="div_pop();">
                                        <button type="button" class="btn btn-success">Add</button></a></li>
                                </ol>
                            </nav>
                        </div>
                    </div>
			...
			<div class="card-body" style="width:80%; padding-left:20px; margin:10px;  border:1px solid #20A8D8; border-radius:10px; display:none;"
             id="add_div">
			<div class="row" >
			<input type="hidden" name="dept_id" id="dept_id" >
					<div class="col-md-4">
						<div class="form-group">
							<label for="cono1" class="control-label col-form-label">Nik Id</label>
							<input type="text"  class="form-control" name="dt_name" id="dt_name" placeholder="Nik Id" required>
						</div>
					</div>
					<div class="col-md-4">
					<div class="form-group">
					...
					<div class="form-group">
					<button type="submit" class="btn btn-success" onclick="save_nikid();">Save</button>
					<button type="reset" class="btn btn-primary">Reset</button>
					<button type="button" class="btn btn-primary" onclick="div_pop();">Cancel</button>
					</div>
					</div>
				</div>
					</div>
                    ...
                    <div class="col-md-12">
                        <div class="card">
							<div class="card-body">
								...
								<div id="infoMsg" style="font-size:10px; color:red; font-weight:bold; text-align:center;"></div>
								<div id="dept_list"><?php echo nikid_list();?></div>
								</div>
							</div>
                        </div>
                    </div>
	...
	function div_pop(){
	  ...
	  function save_nikid(){
		  ...
		  $.ajax({
			...
			type: 'POST',
			data: formdata+'&action=saveNikid',
