...
if(isset($_POST['submit1'])){
	...
	for($i=0;$i<$trows;$i++){
		...
		$insert_fab_costing = mysqli_query($zconn,"insert into ta_planning(ta_group,ta_name,commitment_days,particulars,assignee,created_by,created_date)
		 values('".$_REQUEST['ta_group']."','".$_POST['ta_name'][$i]."','".$_POST['commitment_days'][$i]."','".$_POST['particulars'][$i]."','".$_POST['assignee'][$i]."','".$_SESSION['userid']."',now())");
		//  print '<pre>';
...
<head>
    ...
    <title><?php echo SITE_TITLE;?> - Accessories Process Group Entry</title>
    <!-- Custom CSS -->
    <!-- Custom CSS -->
...
<body>
             ...
             <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">Accessories Process Group Entry</h4>
                        <div class="ml-auto text-right">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="index.php">Home</a></li>
                                    <li class="breadcrumb-item active" aria-current="page"><a href="#">Accessories Process Group Info</a></li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
								...
								<div class="card-body" style="width:100%">
									<div class="card-body" style="width:100%">
										<div class="card" style="width:50%; float:left; left: 50px; ">
											<div class="form-group row">
												...
												<div class="col-sm-6">
													<!-- <select class="select2 form-control custom-select" onchange="this.form.submit();" name="costing_no">
													...
													<select class="select2 form-control custom-select" name="ta_group" id="ta_group" onchange="this.form.submit();" required>
															...
															<?php }  else{?>
																<option value="<?php echo $assgroup['ta_group_name'];?>" <?php if ($assgroup['ta_group_name']==$_REQUEST['ta_group']) {
																	echo "selected";
									...
									<table id="example" class="table table-striped table-bordered">
										...
										<tbody>
											...
											$id=$_GET['id'];
												if ($id!='' && $id!='0'){
													//if ($_REQUEST['ta_group']!='' && $_REQUEST['ta_group']!='0'){
													$select=mysqli_query($zconn,"select * from ta_planning where ta_group='$id' or ta_group='".$_REQUEST['ta_group']."'");
											...
											<td>
														<input type="text" class="form-control" value="<?php echo $data['commitment_days'];?>" id="commitment_days<?php echo $idd;?>" name="commitment_days[]" placeholder="commitment_days" autocomplete="off" onkeyup="cal_amt(<?php echo $idd;?>);" onblur="cal_amt(<?php echo $idd;?>);">
												</td>
												<td>
                                                ...
                                                <td>
														...
														while($res_fabric=mysqli_fetch_array($sel_fabric,MYSQLI_ASSOC)){ if ($res_fabric['uom_name']== $data['uom']) {?>
															<option selected value="<?php echo $res_fabric['uom_name'];?>"><?php echo $res_fabric['uom_name'];?></option>
														<?php } else{ ?>
							...
							$ass_group = mysqli_fetch_array(mysqli_query($zconn,"select * from ta_planning where ta_group_name='".$_REQUEST['ta_group']."'"),MYSQLI_ASSOC);
							...
							<?php } ?>
												...
												<!-- <td>
														<input type="text" class="form-control tramt" name="total[]" id="total<?php echo $id;?>" readonly placeholder="Total" >
												</td> -->
												<td>
													<a class="delete" title="Delete"><button type="button" class="btn btn-info add-new"><i class="fa fa-minus"></i></button></a>
												</td>
										...
										<tbody>
											<tr id="delete_0">
												...
												<td>
														<input type="text" class="form-control" id="grand_tot" readonly placeholder="" style="border: 1px solid #000;">
												</td> -->
											</tr>
										</tbody>
									</table>
							<div class="border-top">
								<div class="card-body" style="margin-left: 250px;">
									...
									<a href="costing_report.html"><button type="button" class="btn btn-danger">List</button></a>
								</div>
							</div>
                        </div>
                    </div>
	...
	function cal_amt(id){
		...
		var cons = $('#particulars'+id).val();

		var rat = $('#commitment_days'+id).val();
		var ctrws=0;
		if(rat){
...
$(document).ready(function(){
	...
	//	$(this).attr("disabled", "disabled");
		...
		var commitment_days_list ="<?php echo $commitment_days_list;?>";
        ...
        var row = '<tr>' +
            ...
            '<td style="padding:0px;"><input type="text" class="form-control" id="commitment_days'+id+'" placeholder="commitment_days" name="commitment_days[]" onkeyup="cal_amt('+id+');" onblur="cal_amt('+id+');"></td>' +
            ...
            '<td style="padding:0px;"><select class="select2 form-control custom-select" name="uom[]"><option> Select</option>'+uom_list+'</select></td>' +
