...
if(isset($_REQUEST['id'])){
	...
	$del_dept = mysqli_query($zconn,"delete from department_costing_list where costing_no='".$_REQUEST['id']."'");
    $del_dept = mysqli_query($zconn,"delete from department_costing where costing_no='".$_REQUEST['id']."'");
	if($del_dept){
		header('location:department_costing_list.php');
	} else {
		echo "0";
	}
}
            ...
            <!-- Bread crumb and right sidebar toggle -->
             <div class="page-breadcrumb">
                ...
                <div class="col-12 d-flex no-block align-items-center">
                    <h4 class="page-title">Department Costing List</h4>&nbsp;&nbsp;&nbsp;&nbsp;
                <div class="row">
                    ...
                    <div class="ml-auto text-right" style="float:right; padding-right:100px;">
                            <nav aria-label="breadcrumb">
								...
								<li>&nbsp;</li>
								<li>&nbsp;</li>
									<li class="breadcrumb-item"><a href="department_process_costing.php"><button type="button" class="btn btn-success">Add New</button></a></li>
                                </ol>
                            </nav>
                        </div>
                    </div>
