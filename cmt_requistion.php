...
<head>
    ...
    <title><?php echo SITE_TITLE;?> - Deparment Requistion Entry</title>
    <!-- Custom CSS -->
    <!-- Custom CSS -->
             ...
             <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">Department Requistion Entry</h4>
                        <div class="ml-auto text-right">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="index.php">Home</a></li>
                                    <li class="breadcrumb-item active" aria-current="page"><a href="requistion.php">deparment Requistion Info</a></li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                        ...
                        <div class="card">
										...
										<div class="card" style="width:50%; float:left; right: 50px;">
											...
											<div class="form-group row">
												...
												<div class="col-sm-6">
													...
													<?php if($_REQUEST['costing_no']==''){?>
												<input type="text" class="form-control"  value="<?php echo $sel_entry1['created_date']; ?>" readonly id="order_date">
											<?php } else{
													?>
													<input type="date" class="form-control" readonly id="order_date" value="<?php echo $sel_costing1['costing_date'];?>" name="order_date">
											<?php } ?>		
												</div>
											</div>
							...
							<div class="border-top">
								<div class="card-body" style="margin-left: 250px;">
									...
									<a href="cmt_requistion_list.php"><button type="button" class="btn btn-danger">Back</button></a>
								</div>
							</div>
                        </div>
                    </div>
