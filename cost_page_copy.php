...
<body>
  ...
  <tr>
    <td width="45%" align="left" valign="top"
        ...
        <img src="assets/images/LOGO VAMAN EXPORTS .png" alt="Your Company Logo" style="max-width: 500px; height: auto;"><br>
    </td>
    <td width="55%" align="center" valign="top"
        style="padding-left:0px; padding-top:10px; padding-bottom:10px; font-size:17px;text-align:center;">
   SF.NO.285,DOOR NO.1WARD NO.51, DHARAPURAM ROAD, UOORGOUNDER NAGAR, Tiruppur, Tamil Nadu, 641608
...
?>
        ...
        <tr>
            <td colspan="7" style="border: 1px solid; width: 23%; padding: 3px; margin: 0; text-align: center;"></td>
...
<table class="table" style="margin-top: -17px; width: 100%;">
    <thead>
        <tr>
            <th style="border: 1px solid; width: 23%; padding: 3px; margin: 0; text-align: center;font-size:18px;" colspan="8">Knitting Costing</th>
        </tr>
        <tr>
            
            <th style="border: 1px solid; width: 33%; padding: 3px; margin: 0; text-align: center;background-color:#FABF8F;">Particulars</th>
            <th style="border: 1px solid; width: 33%; padding: 3px; margin: 0; text-align: center;background-color:#FABF8F;">Rate/kgs</th>
            <th style="border: 1px solid; width: 33%; padding: 3px; margin: 0; text-align: center;background-color:#FABF8F;">Rate/pcs</th>
        </tr>
    </thead>
    <tbody>
        <?php
...
while ($res_cost_det = mysqli_fetch_array($cost_det, MYSQLI_ASSOC)) {
    // Fetching comp_id based on the current row from knit_costing
    $compIdQuery = mysqli_query($zconn, "SELECT comp_id FROM costing_entry_details WHERE costing_id='" . $res_cost_det['costing_no'] . "' AND fabric_name!=''");
    $compIds = [];
    while ($compIdResult = mysqli_fetch_array($compIdQuery, MYSQLI_ASSOC)) {
        ...
        ?>
                <tr>
                    ...
                    <td style="border: 1px solid; width: 23%; padding: 3px; margin: 0; text-align: center;">Knitting Costing</td>
                    <td style="border: 1px solid; width: 23%; padding: 3px; margin: 0; text-align: center;"><?php echo '₹&nbsp;', $res_cost_det['rate_per_kg'];
                        $grant_total_knitting1 += $res_cost_det['rate_per_kg']; ?></td>
                    <td style="border: 1px solid; width: 23%; padding: 5px; margin: 0; text-align: center;"><?php echo '₹&nbsp;', $res_cost_det['rate_per_pc']; ?></td>
                </tr>
        <?php
                $grant_total_knitting += $res_cost_det['rate_per_pc'];
                $sn++;
            }
        }
        ?>
    ...
    <thead>
        <tr>
            <th style="border: 1px solid; width: 23%; padding: 3px; margin: 0; text-align: center;font-size:18px;" colspan="8">Dyeing costing</th>
        </tr>
        <tr>
            
            <th style="border: 1px solid; width: 23%; padding: 3px; margin: 0; text-align: center;background-color:#FABF8F;">Particulars</th>
            <th style="border: 1px solid; width: 23%; padding: 3px; margin: 0; text-align: center;background-color:#FABF8F;">Rate/kgs</th>
            <th style="border: 1px solid; width: 23%; padding: 3px; margin: 0; text-align: center;background-color:#FABF8F;">Rate/pcs</th>
        </tr>
    </thead>
    <tbody>
          <?php
        ...
        $COSTNO = $cost_de['costing_no'];
        if ($COSTNO != '') {
            $cost_det = mysqli_query($zconn, "select   * from dyeing_costing where costing_no='" . $costing_no . "' and fabric_name!=''");
            $count = mysqli_fetch_array(mysqli_query($zconn, "select * costing_entry_details where costing_id='" . $costing_no . "' and fabric_name!=''"), MYSQLI_ASSOC);
            $tot = 75;
            ...
            while ($res_cost_det = mysqli_fetch_array($cost_det, MYSQLI_ASSOC)) {
                ...
                $cost = mysqli_fetch_array(mysqli_query($zconn, "select COUNT(fabric_name) as count,sum(total) as total from dyeing_costing where costing_no='" . $costing_no . "'  and fabric_name!=''"), MYSQLI_ASSOC);
                $total = $cost['total'] / $cost['count'];
        ?>
                <tr>
                   
                    <td style="border: 1px solid; width: 23%; padding: 3px; margin: 0; text-align: center;">Dyeing Costing</td>
                    <td style="border: 1px solid; width: 23%; padding: 3px; margin: 0; text-align: center;"><?php echo '₹&nbsp;', $cost_de['rate']; $total_rate += $cost_de['rate']; ?></td>
                    <td style="border: 1px solid; width: 23%; padding: 5px; margin: 0; text-align: center;"><?php echo '₹&nbsp;', $cost_de['rate_pcs']; $grant_total += $total; $total_rate1 += number_format($total, 2); ?></td>
                </tr>
        <?php
                $sn++;
            }
        ...
        <tr>
            <td colspan="1" style="border: 1px solid; width: 23%; padding: 3px; margin: 0; text-align: center;"></td>
			<td style="border: 1px solid; width: 23%; padding: 3px; margin: 0; text-align: center;font-size:18px;"><strong>Total</strong></td>
            <td style="border: 1px solid; width: 23%; padding: 3px; margin: 0; text-align: center;"><strong><?php echo '₹&nbsp;', round($total_rate1,3); ?><strong></td>
        </tr>
    </tbody>
</table>
...
<table class="table" style="margin-top: -17px; width: 100%;">
    <thead>
		<tr>
    <th style="border: 1px solid; width: 23%; padding: 5px; margin: 0; text-align: center;font-size:18px;" colspan="8">Other Process Costing</th>
</tr>
        <tr>
             
            <th style="border: 1px solid; width: 23%; padding: 3px; margin: 0; text-align: center;background-color:#FABF8F;">Particulars</th>
            <th style="border: 1px solid; width: 23%; padding: 3px; margin: 0; text-align: center;background-color:#FABF8F;">Rate/kg</th>
            <th style="border: 1px solid; width: 23%; padding: 3px; margin: 0; text-align: center;background-color:#FABF8F;">Rate/pcs</th>
        </tr>
    </thead>
    <tbody>
        <?php 
        $distinctFabrics = mysqli_query($zconn, "SELECT DISTINCT fabric_name FROM other_costing WHERE costing_no='".$costing_no."' AND fabric_name!=''");

        while($res_cost_det = mysqli_fetch_array($distinctFabrics, MYSQLI_ASSOC)) {
            $cost_det = mysqli_query($zconn, "SELECT * FROM other_costing WHERE costing_no='".$costing_no."' AND fabric_name='".$res_cost_det['fabric_name']."'");
$sn=1;
            while($other001 = mysqli_fetch_array($cost_det, MYSQLI_ASSOC)) {
                $total = $other001['rate'] * $other001['quantity'];

                echo '<tr>';
				
                echo '<td style="border: 1px solid; width: 23%; padding: 3px; margin: 0; text-align: center;">'.$other001['process_name'].'</td>';
      
$string = '₹&nbsp;' . $other001['rate'];
echo '<td style="border: 1px solid; width: 23%; padding: 3px; margin: 0; text-align: center;">' . $string . '</td>';


// Assuming $other001['rate_pcs'] contains the numeric value you want to round off
$rate_pcs = $other001['rate_pcs']; // Fetching the value

// Rounding off the value to 2 decimal places
$rounded_value = round($rate_pcs, 2);

// Creating the string with the rounded value
$string1 = '₹&nbsp;' . $rounded_value;
                echo '<td style="border: 1px solid; width: 23%; padding: 3px; margin: 0; text-align: center;">'.$string1.'</td>';
                echo '</tr>';
				$sn++;
				$total_1 += $other001['rate'];
				$total_2 +=$other001['rate_pcs'];
            }
        }
        ?>
		 <tr>
            <td colspan="1" style="border: 1px solid; width: 23%; padding: 3px; margin: 0; text-align: center;"></td>
			<td style="border: 1px solid; width: 23%; padding: 3px; margin: 0; text-align: center;font-size:18px;"><strong>Total</strong></td>
            <td style="border: 1px solid; width: 23%; padding: 3px; margin: 0; text-align: center;"><strong><?php echo '₹&nbsp;',round($total_2); ?><strong></td>
        </tr>
    </tbody>
</table>
<table class="table" style="margin-top: -17px; width: 100%;">
...
<table class="table" style="margin-top: -17px; width: 100%;">
    ...
    <tbody>
        ...
        while($fabric = mysqli_fetch_array($cost_ass, MYSQLI_ASSOC)) {
			...
			$rejection= $fab_total*$fabric['rejection']/100;
			$overhead= $over_total*$fabric['over_head']/100;
			$others= $over_total*$fabric['compos']/100;
			...
			echo '<td style="border: 1px solid; width: 23%; padding: 3px; margin: 0; text-align: center;">₹&nbsp'.number_format($fabric['other_cost'], 2).'</td>';
			...
			///echo '<td style="border: 1px solid; width: 23%; padding: 3px; margin: 0; text-align: center;">₹&nbsp</td>';
	...
	<tr>
            ...
            <td style="border: 1px solid; width: 23%; padding: 3px; margin: 0; text-align: center;"><strong><?php  $ove_tot=$fab_total+$overhead+$pro_loss+$total_dept1+$total2+$total_2+$other_cost+$rejection+$factory_cost;  echo '₹&nbsp;',round($ove_tot) ?></strong></td>
        </tr>
	</table>
