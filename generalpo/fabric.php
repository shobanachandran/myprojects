<?php
    ...
    if (isset($_POST['save'])) {
        ...
        if (isset($_POST['style_no']) && isset($_POST['desc'])  && isset($_POST['fabric_name'])  && isset($_POST['hsn'])&& isset($_POST['gsm']) && isset($_POST['pcs_wgt']) && isset($_POST['price']) && isset($_POST['color']) && isset($_POST['dia'])) {
...
`to_process`, `cgst`,`sgst`,`igst`, `style_no`,`fabric_name`, `desc`, `pcs_wgt`, `price`, `hsn`, 
`gsm`, `color`, `dia`, `status`, `pay_status`)
  VALUES ('$po_no',  NOW(), '$received_date','$to_address', '$comments', '$delivery_to', '$to_process','$cgst','$sgst','$igst','$style_no', '$fabric_name','$desc',  '$pcs_wgt', '$price',  '$hsn', '$gsm', '$color', '$dia','pending','pending')";
...
echo '<legend>Fabric Details</legend>
