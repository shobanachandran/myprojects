...
<div class="col-md-6 col-lg-2 col-xlg-3">
                                        <div class="card card-hover">
                                            <div class="box bg-warning text-center">
                                                <a href="knitting_costing_list.php"><h1 class="font-light text-white"><i class="mdi mdi-account-check"></i></h1>
                                                <h6 class="text-white">Knitting Costing </h6></a>
                                            </div>
                                        </div>
                                    </div>
									<!-- Column -->
                                    <div class="col-md-6 col-lg-2 col-xlg-3">
                                        <div class="card card-hover">
                                            <div class="box bg-success text-center">
                                                <a href="dyeing_costing_list.php"><h1 class="font-light text-white"><i class="mdi mdi-account-key"></i></h1>
                                                <h6 class="text-white">Dyeing Costing </h6></a>
                                            </div>
                                        </div>
                                    </div>
                                    <!-- Column -->
                                    <div class="col-md-6 col-lg-2 col-xlg-3">
                                        <div class="card card-hover">
                                            <div class="box bg-danger text-center">
                                                <a href="other_costing_list.php"><h1 class="font-light text-white"><i class="mdi mdi-flag"></i></h1>
                                                <h6 class="text-white" style="font-size:13px;">Other Process Costing </h6></a>
                                            </div>
                                        </div>
                                    </div>
                                    <!-- Column -->
