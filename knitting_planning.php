                        ...
                        <div class="card">
							...
							<div class="card" style="width:50%; float:left; left: 50px; ">
								<div class="form-group row">
									<label for="fname" class="col-sm-3 text-right control-label col-form-label">Inent No</label>
									<div class="col-sm-6">
									<select class="select2 form-control  chosen-select" name="sel_order" id="sel_buyer" required onchange="sel_styles(this.value);">
										<option value="0">--Select--</option>
										  <?php
									  $sel_buyer = mysqli_query($zconn,"select * from order_entry_master where (`order_no`,`style_no`) NOT IN(select order_no,style_no from knitting_planning_master) and (`order_no`,`style_no`) IN (select order_no,style_no from process_planning_flow where process_flow!='fabric')");
