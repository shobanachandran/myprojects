...
<head>
    ...
    <title><?php echo SITE_TITLE;?> - Work assign edit	</title>
    <!-- Custom CSS -->
    <!-- Custom CSS -->
        ...
        <div class="page-wrapper" style="min-height: 100%; height: auto;">
             ...
             <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">Work assign edit</h4>
                        <div class="ml-auto text-right">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="index.php">Home</a></li>
                                    <li class="breadcrumb-item active" aria-current="page"><a href="#">Work Assign Edit</a></li>
                                </ol>
                            </nav>
                        </div>
                    </div>
			...
			<div class="container-fluid">               
                ...
                <option value="power">Power</option>
                                    ...
                                    <div class="form-group row">
                                        <label for="from" class="col-sm-3 text-right control-label col-form-label">&nbsp;FromDeparment</label>
                                        <div class="col-sm-6">
                                ...
                                <div class="card" style="width:50%; float:left; right: 50px;">
                                    ...
                                    <div class="form-group row">
                                        <label for="cono1" class="col-sm-3 text-right control-label col-form-label">DC Return Date</label>
                                        <div class="col-sm-6">
                                    ...
                                    <div class="form-group row">
                                        <label for="fname" class="col-sm-3 text-right control-label col-form-label">&nbsp;From Contractor</label>
                                        <div class="col-sm-6">
