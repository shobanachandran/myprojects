                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="plan">UNIT:</label>
                                                <input type="text" id="plan" class="form-control" name="plan" value="">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="lookup-date">PLAN DATE:</label>
                                                <input type="date" id="lookup-date" class="form-control" name="lookup-date" value="<?php echo date('Y-m-d');?>">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="actual">RECEIVED:</label>
