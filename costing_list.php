...
<body>
    <div id="main-wrapper">
		...
		<form name="costing_list" id="costing_list" method="post">
		  ...
		  <table id="example" class="table table-striped table-bordered display">
				...
				<tbody>
	<?php
		$sql_con = "WHERE cost_type='yarn' ";

		if(isset($_POST['sel_buyer']) && $_POST['sel_buyer'] !== ''){
			$sql_con .= "AND id='" . $_POST['sel_buyer'] . "' ";
		}
		
		$costing_sql = mysqli_query($zconn, "SELECT * FROM costing_entry_master " . $sql_con . " ORDER BY id DESC");
			...
			<tr id="delete_<?php echo $c;?>">
				<td><?php echo $c;?></td>
				<td><?php echo $res_costing['costing_no'];?></td>
	...
	<script>
		function costing_sheet(cost_id){
			 window.open("cost_page.php?costing_no="+cost_id, "Costing Sheet", "width=800,height=700");
		}
	</script>
    <script>
