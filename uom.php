...
<head>
    ...
    <title><?php echo SITE_TITLE;?> - UOM</title>
    <!-- Custom CSS -->
	<!--  datatables CSS -->
			...
			<input type="hidden" name="dept_id" id="dept_id" >
					<div class="col-md-4">
						<div class="form-group">
							<label for="cono1" class="control-label col-form-label">UOM Name</label>
							<input type="text"  class="form-control" name="dt_name" id="dt_name" placeholder="UOM Name" required>
						</div>
					</div>
					<!--<div class="col-md-4">
					<div class="form-group">
                        ...
                        <div class="card">
							<div class="card-body">
								<div class="table-responsive">
									<div id="dept_list"><?php echo uom_list();?></div>
								</div>
							</div>
                        </div>
                    </div>
