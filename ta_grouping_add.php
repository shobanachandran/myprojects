...
if(isset($_POST['submit'])){
	...
	$insert_acc =  mysqli_query($zconn,"insert into ta_grouping(ta_group_name,
	ta_names,created_by,created_date) values('".$grp_name."',
	'".$acc_list."','".$_SESSION['userid']."',now())");
	if($insert_acc){
                        ...
                        <div class="card">
								<div class="card-body" style="width:100%">
									<div class="form-group row">
										...
										<div class="col-sm-3">
											<input type="text" class="form-control" name="ta_group_name" id="fname" placeholder="Group name">
										</div>
									</div>
