             ...
             <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">Investor Add</h4>
                        <div class="ml-auto text-right">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="index.php">Home</a></li>
                                    <li class="breadcrumb-item active" aria-current="page"><a href="investors.php">GST Info</a>
									</li>
                                </ol>
                            </nav>
                        </div>
                        ...
                        <div class="card">
							<div class="card-body">
								...
								<div class="card-body" style="width:100%">
									<div class="form-group row">
										...
										<div class="col-sm-3">
											<input type="text" class="form-control" id="fname" placeholder="Investor name">
										</div>
									</div>
							...
							<div class="border-top">
								<div class="card-body" style="margin-left: 250px;">
									...
									<a href="investors.php"><button type="submit" class="btn btn-danger">Back</button></a>
								</div>
							</div>
                        </div>
                    </div>
