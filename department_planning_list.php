...
<head>
    ...
    <title><?php echo SITE_TITLE;?> - Department Planning</title>
    <!-- Custom CSS -->
	<!--  datatables CSS -->
            ...
            <!-- Bread crumb and right sidebar toggle -->
             <div class="page-breadcrumb">
                ...
                <div class="col-12 d-flex no-block align-items-center">
                    <h4 class="page-title">Department Planning List</h4>&nbsp;&nbsp;&nbsp;&nbsp;
                <div class="row">
                    
						<a href="planning.php"> 
                            <button type="button" class="btn btn-info">Planning Process</button></a>  
                    ...
                    <div class="ml-auto text-right" style="float:right; padding-right:100px;">
                            <nav aria-label="breadcrumb">
								...
								<li>&nbsp;</li>
								<li>&nbsp;</li>
									<li class="breadcrumb-item"><a href="department_planning.php"><button type="button" class="btn btn-success">Add New</button></a></li>
                                </ol>
                            </nav>
                        </div>
                    </div>
							...
							<div class="card-body">
								<div class="table-responsive">
                                  ...
                                  <!--                <td><?php echo $res_group['total'];?></td>  -->
												<td><a href="department_planning.php?id=
