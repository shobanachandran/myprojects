...
<head>
    ...
    <title><?php echo SITE_TITLE;?> - Yarn Name</title>
    <!-- Custom CSS -->
             ...
             <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">Yarn Type</h4>&nbsp;&nbsp;&nbsp;&nbsp;
			...
			<input type="hidden" name="dept_id" id="dept_id" >
					<div class="col-md-4">
						<div class="form-group">
							<label for="cono1" class="control-label col-form-label">Yarn Name</label>
					...
					<div class="form-group">
					<button type="submit" class="btn btn-success" onsubmit="save_dept();">Save</button>
                    ...
                    <div class="col-md-12">
                        <div class="card">
							<div class="card-body">
								...
								<div id="dept_list"><?php echo yarnname_list();?></div>
								</div>
							</div>
                        </div>
                    </div>
    ...
    $('#example').DataTable();
	 ...
	 function save_dept(){
		  ...
		  $.ajax({
			...
			type: 'POST',
			data: formdata+'&action=saveYarnName',
