...
<head>
    ...
    <title><?php echo SITE_TITLE;?> - Department Name</title>
    <!-- Custom CSS -->
			...
			<input type="hidden" name="dept_id" id="dept_id" >
					<div class="col-md-4">
						<div class="form-group">
							<label for="cono1" class="control-label col-form-label">Department Name</label>
                    ...
                    <div class="col-md-12">
                        <div class="card">
							<div class="card-body">
								...
								<div id="dept_list"><?php echo process_list1();?></div>
								</div>
							</div>
                        </div>
                    </div>
