...
<?php
    ...
    if (isset($_POST['save'])) {
        ...
        if (isset($_POST['desc']) &&  isset($_POST['pcs_wgt']) && isset($_POST['price'])) {
...
`to_process`, `cgst`,`sgst`,`igst`,  `desc`,   `pcs_wgt`, `price`, `status`, `pay_status`)
  VALUES ('$po_no',  NOW(), '$received_date','$to_address', '$comments', '$delivery_to', '$to_process','$cgst','$sgst','$igst', 
  '$desc',  '$pcs_wgt', '$price', 'pending','pending')";
...
<legend>Other Details</legend>
    ...
    <th width="5%">
                    <button type="button" class="btn btn-danger btn-sm ml-2" onclick="addRow3()"><i class="fas fa-plus-circle fa-lg"></i></button>
                </th>			</tr>
        </thead>
