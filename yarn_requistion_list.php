...
<head>
    ...
    <title><?php echo SITE_TITLE;?> - Yarn requistion List </title>
    <!-- Custom CSS -->
	<!--  datatables CSS -->
...
<body>
             ...
             <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">Yarn Requistion List</h4>
						...
						<div class="col-sm-3">
                            ...
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
									...
									<li class="breadcrumb-item active" aria-current="page"><a href="requistion.php">Yarn Requistion</a></li>
                                </ol>
                            </nav>
                        </div>
                    </div>
	...
	<?php
			...
			$costing_sql = mysqli_query($zconn,"select * from yarn_entry_master ".$sql_con."");
			$c=1;
			...
			<tr id="delete_<?php echo $c;?>">
				...
				<td><a href="edit_yarn_requistion.php?id=<?php echo addslashes($res_costing['id']);?>">
				<i class="fas fa-edit"></i>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				<!-- <a onclick="DeleteUsrId('<?php echo $c;?>');"><i class="fas fa-window-close"></i></a>-->
				<a href="javascript:;"><i class="fas fa-print"></i></a></td>
			</tr>
