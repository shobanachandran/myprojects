...
<head>
    ...
    <title><?php echo SITE_TITLE;?> - Accessories</title>
    <!-- Custom CSS -->
	<!--  datatables CSS -->
             ...
             <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">Accessories</h4>&nbsp;&nbsp;&nbsp;&nbsp;
			...
			<input type="hidden" name="dept_id" id="dept_id" >
					<div class="col-md-4">
						<div class="form-group">
							<label for="cono1" class="control-label col-form-label">Accessories Name</label>
							<input type="text"  class="form-control" name="dt_name" id="dt_name" placeholder="Accessories Name" required>
						</div>
					</div>
					<div class="col-md-4">
					<div class="form-group">
					...
					<div class="form-group">
					<button type="button" class="btn btn-success" onclick="save_accs();">Save</button>
                        ...
                        <div class="card">
							<div class="card-body">
								<div class="table-responsive">
									<div id="dept_list"><?php echo accessories_list();?></div>
								</div>
							</div>
                        </div>
                    </div>
	...
	function div_pop(){
	  ...
	  function save_accs(){
		  ...
		  $.ajax({
			...
			type: 'POST',
			data: formdata+'&action=save_accessories',
			success: function( data ) {
				...
				if($.trim(data['0'])=="2"){
					...
					$('#add_div').slideToggle();
					$('#infoMsg').fadeIn(3000);
					$('#infoMsg').html("Exist in the Data(s)!!");
