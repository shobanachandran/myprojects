...
if(isset($_REQUEST['id'])){
	...
	$del_dept = mysqli_query($zconn,"delete from accessories_costing_list where costing_no='".$_REQUEST['id']."'");
    $del_dept = mysqli_query($zconn,"delete from accessories_costing where costing_no='".$_REQUEST['id']."'");

	if($del_dept){
		header('location:accessories_costing_list.php');
	} else {
		echo "0";
	}
}
...
<head>
    ...
    <title><?php echo SITE_TITLE;?> - Accessories Costing List</title>
    <!-- Custom CSS -->
	<!--  datatables CSS -->
             ...
             <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
						<h4 class="page-title">Accessories Costing List</h4>
                        &nbsp;&nbsp;&nbsp;&nbsp; <a href="costing.php"> <button type="button" class="btn btn-info">Costing Process</button></a>
                        
                        <div class="ml-auto text-right">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
									<li class="breadcrumb-item"><a style="background-color:#626F80; 
                                    color:#fff; color:#fff; margin:10px; padding:10px;" href="accessories_process_costing.php">Add New  </a></li>
									...
									<li class="breadcrumb-item active" aria-current="page">Accessories Costing</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                                ...
                                <ol class="breadcrumb">
									<li class="breadcrumb-item">
										<label for="fname" style="font-size:16px;">&nbsp;Costing No</label>
											...
											<?php $sel_buyer = mysqli_query($zconn,"select * from 
                                            costing_entry_master where 1 group by costing_no");
							...
							<div class="card-body" style="min-height:500px;">
								<div class="table-responsive">
									<table id="example" class="table table-striped table-bordered">
										...
										$sel_group = mysqli_query($zconn,"select * from accessories_costing_list ".$sql_buer." ORDER by id DESC");
										$g=1;
                                  ...
                                  <!--                <td><?php echo $res_group['total'];?></td>  -->
												<td><a href="accessories_process_costing.php?id=<?php echo $res_group['costing_no'];?>" title="Edit"><i class="fas fa-edit"></i></a> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
													<!--a href="accessories_costing_list.php?id=<?php echo $res_group['costing_no'];?>" title="Delete"> <i class="fas fa-window-close"></i></a-->
												</td>
											</tr>
										<?php $g++;} ?>
										</tbody>
